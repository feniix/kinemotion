...
2. Processes all with batch mode (4 workers)
3. Compares all results for identity
4. Reports variance statistics
...
3. Creates/selects Google Cloud project
4. Enables required APIs
5. Guides through OAuth consent screen setup
6. Guides through OAuth client creation
7. Collects credentials for Supabase configuration
...
2. Run variance analysis: `./scripts/analyze_determinism_variance.py`
3. Open issue with test results
...
4. Add results template to `docs/validation/`
5. Update validation roadmap if needed
