...
- **test**: Add modern coverage reporting with pytest-cov
  ([`4a9d786`](https://github.com/feniix/kinemotion/commit/4a9d7864201cd4a298e10bd4346f4f66cd678980))
...
- Force build to test new trusted publisher in pypi
  ([`f418396`](https://github.com/feniix/kinemotion/commit/f4183968af72da639e804e05c52975c1ad4871ba))
...
- Enable Trusted Publishing for PyPI uploads
  ([`25e93c3`](https://github.com/feniix/kinemotion/commit/25e93c38bfb9f9e77a2b11bc3d228589bff678cc))
...
- Force build to test new trusted publisher in pypi
  ([`38886f6`](https://github.com/feniix/kinemotion/commit/38886f665d75255b3fafd8cd63e7b36835e41ac9))
...
- Use pypa/gh-action-pypi-publish for PyPI uploads
  ([`ebed73d`](https://github.com/feniix/kinemotion/commit/ebed73dda7b69816a6f6dbe5f88a6c43090b2c10))
...
- Add semantic-release publish step to upload to PyPI
  ([`941a151`](https://github.com/feniix/kinemotion/commit/941a15132bc790058ee8ef89e1020c507cc45f2d))
...
- Add allow_zero_version = true to prevent unwanted 1.0.0 bump
  ([`5ac8bc6`](https://github.com/feniix/kinemotion/commit/5ac8bc6607827420a641970902da30722a641170))

- Configure PyPI publishing with uv and custom token variable
  ([`bbc55cb`](https://github.com/feniix/kinemotion/commit/bbc55cba4541c43257aabecfb3ef7161f86a341e))

- Correct pyproject.toml and move semantic-release config
  ([`9242ecf`](https://github.com/feniix/kinemotion/commit/9242ecfa2c714157dd0b2252f9b5ef5d8516d2d7))

- Update uv version to 0.8.17 in release workflow
  ([`740a613`](https://github.com/feniix/kinemotion/commit/740a61377fdb4ac57f66f748f07f44c1c892026c))

- Use semantic-release version command instead of publish
  ([`98b0c5a`](https://github.com/feniix/kinemotion/commit/98b0c5aca9f0a8b50918b072edf23544d6a54c30))
