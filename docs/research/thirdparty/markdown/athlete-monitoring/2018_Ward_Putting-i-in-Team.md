...
**DOI** : [https://doi.org/10.1123/ijspp.2018-0154](https://doi.org/10.1123/ijspp.2018-0154)
...
[Email: amccall@arsenal.co.uk](mailto:amccall@arsenal.co.uk)

**Submission type:** Invited commentary

**Running title:** There _is_ an ‘I” in team
...
There is a common expression in sports, that _there is no ‘i’ in team_ . However, there is also a very
...
There is a well-known saying in sport; ‘ _there is no ‘i’ in team_ ’, and the current authors argue

that, collectively, there _is_ a very important ‘ _i_ ’ in team – the ‘ _individual’_ . In the current authors affiliated
...
‘
_individual_ . The methods of analysis discussed can supplement the daily interaction with players,

allowing recommendations for modifications to training to be discussed with the coaching staff’.

**Analysing** _**individual**_ **player data**
...
_Magnitude-Based Inference for Assessing Individuals_
...
represent the change that is most meaningful for the given population ( _slow working sports science_ approach).
...
7. Coutts, A.J., S. Crowcroft, and T. Kempton, _Developing athlete monitoring systems: Theoretical_

_basis and practical applications_, in _Sport, Recovery and Performance: Interdisciplinary_
_Insights_, M. Kellmann and B. Beckmann, Editors. 2017, Routledge: Abingdon. p. in press.
...
- 2 testing day and see where a players hamstring isometric force is out with their normal range i.e. outwith statistical control.
